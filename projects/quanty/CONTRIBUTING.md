...
```
src/core/bytes.js     formatBytes / parseBytes
src/core/number.js    formatNumber / formatCompact
src/core/ordinal.js   ordinal
src/index.js          barrel exports
src/cli.js            command-line interface
bin/quanty.js         CLI entry point
test/*.test.js        node:test suites
```

## Adding a function

1. Put it in the most relevant `src/core/*.js` module.
...
5. Document it in `README.md`, `README.zh-CN.md`, and `docs/format.md`.
...
- Prefer small, pure functions with explicit `TypeError`/`RangeError` for bad input.
- Keep the browser path working: only use APIs available in modern browsers.
