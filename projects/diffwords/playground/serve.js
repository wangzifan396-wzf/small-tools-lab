#!/usr/bin/env node
/**
 * Tiny static file server for the diffwords playground.
 *
 * No dependencies. Serves the playground directory and the library source so
 * the browser can `import` diffwords as native ESM.
 *
...
server.listen(PORT, () => {
  console.log(`diffwords playground → http://localhost:${PORT}/`);
